...
<div class="card shadow mb-4 col-md-6 mx-auto mb-4">
    ...
    <div class="card-body">
        <form id="addDoctorForm" action="{{ url('upload_doctor') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="doctorName">Nama:</label>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="doctorStatus" name="doctorStatus" required>
            ...
            <div class="form-group">
                <label for="doctorPhoneNumber">Nomor Telepon:</label>
...
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Daftar Dokter</h6> </div>
...
<style>
    ...
    button,
    input[type="file"] {
        width: 100%; /* Make the form elements fill their container */
        padding: 8px; /* Add some padding for better appearance */
        box-sizing: border-box; /* Include padding and border in the element's total width and height */
        border: 1px solid #ccc; /* Add a border to the form elements */
    ...
    input[type="file"] {
        ...
        margin-bottom: 20px; /* Add more bottom margin for file input */
    }
</style>
    ...
    <tbody id="doctorTableBody">
         ...
         @foreach($doctors as $doctor)
            <tr>
                ...
                <td>
                    @if ($doctor['foto'])
                        <img src="{{ asset('storage/' . $doctor['foto']) }}" alt="Doctor Image" width="50" height="50">
                    @else
                        No Image
                    @endif
                </td>
